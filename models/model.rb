def dessert(flavour, time, dish)
  ...
  if flavour == "Sweet" && time =="10-20" && dish =="cold"
    return [{
      :name => "Fruit Soup",
  ...
  elsif flavour == "Sweet" && time =="21-30" && dish =="hot"
    return [{
  ...
  elsif flavour == "Sweet" && time =="31+" && dish =="hot"
    return [{
  ...
  elsif flavour == "Salty" && time =="10-20" && dish =="cold"
    return [{
  ...
  elsif flavour == "Salty" && time =="21-30" && dish =="cold"
    return [{
  ...
  elsif flavour == "Salty" && time =="31+" && dish =="cold"
    return [{
  ...
  elsif flavour == "Salty" && time =="21-30" && dish =="hot"
    return [{
  ...
  elsif flavour == "Salty" && time =="31+" && dish =="hot"
    return [{
